...
public class ConditionFragment extends Fragment implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		weiduShowAdapter=new WeiduShowAdapter(getActivity(), weidusShow);
		...
		weiduShowHangAdapter=new WeiduShowAdapter(getActivity(), weidusHangShow);
		weidu_hang_lv.setAdapter(weiduShowHangAdapter);
		weiduShowLieAdapter=new WeiduShowAdapter(getActivity(), weidusLieShow);
